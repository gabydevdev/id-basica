...
define( 'MY_ACF_PATH', IDBASICA_THEME_DIR . '/inc/acf/advanced-custom-fields-pro/' );
define( 'MY_ACF_URL', IDBASICA_THEME_URI . '/inc/acf/advanced-custom-fields-pro/' );
...
require_once IDBASICA_THEME_DIR . '/inc/acf/init.php';
